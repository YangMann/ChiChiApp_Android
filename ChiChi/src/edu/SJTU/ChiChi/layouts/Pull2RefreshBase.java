...
import edu.SJTU.ChiChi.utils.LoadingLayoutProxy;
import edu.SJTU.ChiChi.utils.OverscrollHelper;
import edu.SJTU.ChiChi.utils.P2RMisc;
import edu.SJTU.ChiChi.utils.ViewCompat;

public abstract class Pull2RefreshBase<T extends View> extends LinearLayout implements IPull2Refresh<T> {
    ...
    public Pull2RefreshBase(Context context, Mode mode) {
        super(context);
        mMode = mode;
        init(context, null);
    }

    public Pull2RefreshBase(Context context, Mode mode, AnimationStyle animStyle) {
        super(context);
        mMode = mode;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
            ...
            P2RMisc.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
    ...
    public static enum Mode {
         ...
         * {@link Pull2RefreshBase#setRefreshing() setRefreshing()}.
         */
     ...
     * {@link Pull2RefreshAdapterViewBase#setOnLastItemVisibleListener}.
     *
     * @author Chris Banes
     */
     ...
     * (such as sounds). See (
     * {@link Pull2RefreshAdapterViewBase#setOnPullEventListener}.
     *
     * @author Chris Banes
     */
    public static interface OnPullEventListener<V extends View> {
         ...
         */
        public void onPullEvent(final Pull2RefreshBase<V> refreshView, State state, Mode direction);
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                ViewCompat.postOnAnimation(Pull2RefreshBase.this, this);
            } else {
                if (null != mListener) {
