...
import edu.SJTU.ChiChi.layouts.IndicatorLayout;
import edu.SJTU.ChiChi.layouts.Pull2RefreshBase;

public abstract class Pull2RefreshAdapterViewBase<T extends AbsListView> extends Pull2RefreshBase<T> implements
        OnScrollListener {
    ...
    public Pull2RefreshAdapterViewBase(Context context, Mode mode) {
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }

    public Pull2RefreshAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle) {
     ...
     * {@link Pull2RefreshBase#isPullToRefreshOverScrollEnabled()
    ...
    /**
     * Pass-through method for {@link Pull2RefreshBase#getRefreshableView()
     * getRefreshableView()}.
